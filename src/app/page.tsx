  ...
  return (
    <main className="w-full h-screen bg-gradient-to-tl from-muted flex flex-col md:justify-center p-6 overflow-x-hidden">
      <div className="w-full max-w-[1200px] mx-auto flex flex-col md:flex-row gap-8 md:gap-12">
        <div>
          <Logo className="w-fullm max-w-[100px] mb-8" />
        ...
        <div className="flex-1 relative h-full">
          <Image
            ...
            width={1200}
            height={800}
            className="md:absolute md:top-1/2 md:-translate-y-1/2 md:left-0 md:min-w-[80vw] rounded-lg overflow-hidden border-2 border-muted"
          />
        </div>
      </div>
    </main>
